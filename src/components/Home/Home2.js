...
function Home2() {
  ...
  I specialize in <b className="purple">DevOps</b> and <b className="purple">Full-Stack Development</b>, with a strong focus on building scalable and high-performance infrastructure. My expertise includes cloud deployment, automation, and CI/CD pipelines. I am passionate about optimizing systems for seamless deployment and ensuring reliability through cloud-native solutions.
  <br />
  <br />
        ...
        <Row>
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              ...
              <li className="social-icons">
                <a
                  href="https://twitter.com/RaghavB59903804"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/Raghavendrabaheti"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
              ...
              <li className="social-icons">
                <a
                  href="https://www.instagram.com/raghav__baheti"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour home-social-icons"
                >
